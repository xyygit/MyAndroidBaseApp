...
public class ExMemoryUtil {
    private static final String TAG = ExMemoryUtil.class.getSimpleName();
    ...
    public static String printMemInfo() {
        String info = ExFileUtil.getInstance().readFile(MEM_INFO_PATH);
        ExLogUtil.i(TAG, "_______  内存信息:   \n" + info);
        return info;
    }
